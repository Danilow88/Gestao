...
# --- FUNÇÕES AUXILIARES PARA ESTOQUE_MANAGER ---
...
def render_estoque_por_prateleira(estoque_manager: EstoqueManager):
    ...
    try:
        # Usar o módulo de mapeamento integrado
...
# --- CONTINUA COM O RESTO DO DASHBOARD.PY ORIGINAL ---
# Aqui vai todo o resto do código do dashboard original...
